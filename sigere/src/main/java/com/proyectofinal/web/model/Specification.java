...
public class Specification{
	...
	private final String version; //The version of the specification.
	
	public Specification (final int id,final String code, final String name,final Date date, final String gradeOfNeed, final String description, final String entry,
