...
public class VersionSRS {
	...
	public VersionSRS (final int SRSId, final int id, final String systemProspect, final String scope, final String objectives, final String definitions,
			...
			final String productFunctions, final String domainModel, final String restrictions, final String suppositions,final String dbRequirements, 
			final String designRestrictions, final String ruleAcceptance, final int projectId, final String version) {
		this.SRSId=SRSId;
		this.id=id;
